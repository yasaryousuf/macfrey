    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('company.update', ['id' => $company->id])}}" method="POST" name="create-company">
                    @method('PUT')
                    @csrf

                    <div class="form-group">
                        <label for="company-name">Name</label>
                        <input type="text" class="form-control" value="{{$company->name}}" name="name" id="company-name" required>
                    </div>
                    <div class="form-group">
                        <label for="company-slug">Slug</label>
                        <input type="text" class="form-control" value="{{$company->slug}}" name="slug" id="company-slug" required>
                    </div>
